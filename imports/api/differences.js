...
export const DIFFERENCES = [{
    ...
    fileNum: 320,
    nature: 'D',
    alertAccounts: ['^(?!63514|[1-5]).*'],
    alertLabs: ['véhicules de société', 'vehicules de societe', 'tvs', 'tvts'],
    questions: [],
    manualAmount: false,
    debitAccount: 'F19',
    creditAccount: 'auto',
    ...
    fileNum: 364,
    nature: 'D',
    alertAccounts: ['^(?!6711|6712|[1-5]).*'],
    alertLabs: ['amende', 'amendes', 'pénalité', 'penalite', 'pénalités', 'penalites', 'majoration'],
    questions: [],
    manualAmount: false,
    debitAccount: 'F19',
    creditAccount: 'auto',
