...
new Tabular.Table({
    ...
    extraFields: ['formattedDate']
});

new Tabular.Table({
    ...commonTabularOptions,
    name: 'DivergentWritings',
    collection: Writings,
    columns: [
        {
            data: 'num',
            ...
            title: 'Actions',
            tmpl: Meteor.isClient && Template.divergentWritingListActions,
            tmplContext: writing => ({
                writing
            })
        }
    ],
    extraFields: ['formattedDate', 'journalCode', 'differenceId']
});
