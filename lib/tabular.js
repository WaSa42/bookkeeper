...
new Tabular.Table({
    ...
    extraFields: ['formattedDate', 'journalCode']
});
...
new Tabular.Table({
    ...
    extraFields: ['formattedDate', 'num', 'lab', 'originalWritingId']
});

const commonDivergencesExtreFields = ['formattedDate', 'journalCode', 'differenceId', 'differenceType'];
...
new Tabular.Table({
    ...
    columns: [
        ...
        {
            title: 'Actions',
            tmpl: Meteor.isClient && Template.divergentWritingList2Actions,
            tmplContext: writing => ({
                writing
            })
        }
